<?php
    ...
    if($user->getroleid()!="2"){
      echo "<script> alert('Nice Try, use a manager account!'); location='../view/index.php';</script>";
    }
...
<body>
<form action="../controller/manageredit.php" method="POST">
  <div class="container">
    <h1>Edit Item <?php echo $item->getitemname(); ?></h1>
    <p>ID can't be edited</p>
    <p>Note: Price and Stock can't be negative value</p>
    <hr>

    <label><b>Item Name</b></label>
    <input type="text" placeholder="Item Name" name="itemname2" value='<?php echo $item->getitemname();?>'>
    <input type="hidden" name="itemname" value='<?php echo $item->getitemname();?>'>
