  ...
  <p>ID : <?php echo $user->getuserid(); ?>
	...
	<table id="dat" class="table table-hover">
      ...
      while ($row = $result->fetch_assoc()) {
            ...
            echo "<form method='post' action='manageitem.php'>";
            ...
            echo "</div>";
            echo "<div class='col-sm-3'>";
		    echo "<form method='post' onsubmit='return show_alert()' action='../controller/deleteitem.php'>";
			echo "<input type='hidden' name='itemid' value='".$row['item_id']."'>";
			echo "<input type='hidden' name='do' value='item.php'>";
